...
def parse_extracted_text(extracted_text):
    """
    Detects the separator dynamically and splits rows into columns.
    """
    ...
    for line in lines:
        if "|" in line:
            ...
            # If no delimiter is detected, assume spaces
            columns = re.split(r"\s{2,}", line)  # Splitting by multiple spaces
...
def main():
    ...
    image_path_2 = "1.jpg"  # Replace with your actual path
    ...
    response = client.models.generate_content(
        ...
        contents=["Extract table information from these images and return it as a JSON array of rows and columns.",
    ...
    try:
        table_rows = json.loads(extracted_text)
    except json.JSONDecodeError:
        table_rows = parse_extracted_text(extracted_text)
